...
func init() {
	...
	ERROR_INFO_MAP[ERROR_CODE_OPERATE_ILLEGAL] = "非法操作"
	ERROR_INFO_MAP[ERROR_CODE_DATABASE_CONNECT_FAILED] = "连接数据库失败"
	ERROR_INFO_MAP[ERROR_CODE_DATABASE_CONNECT_CLOSE_FAILED] = "关闭数据库连接失败"
	ERROR_INFO_MAP[ERROR_CODE_DATABASE_QUERY_FAILED] = "数据库操作失败"
