...
const ERROR_CODE_OPERATE_ILLEGAL int = 1005      //非法操作

const ERROR_CODE_DATABASE_CONNECT_FAILED int = 1100       //连接数据库失败
const ERROR_CODE_DATABASE_CONNECT_CLOSE_FAILED int = 1101 //关闭数据库连接失败
const ERROR_CODE_DATABASE_QUERY_FAILED int = 1102         //数据库操作失败
